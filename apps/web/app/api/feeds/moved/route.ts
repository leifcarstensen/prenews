...
import { feedQuerySchema, formatProbability, formatDelta, formatResolvesIn } from "@prenews/shared";
...
export async function GET(request: NextRequest) {
  ...
  const items = await getFeedItems("moved", parsed.data.limit, parsed.data.category);
